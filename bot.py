...
async def help_command(update, context):
    await update.message.reply_text("Voici les commandes disponible :\n/start -pour  Démarrer le bot\n/help - pour recevoir de l'Aide\nÉcris-moi un mot-clé comme 'vidéo' ou 'image'.")

# Fonction pour gérer tous les messages normaux
async def handle_message(update, context):
    ...
    if "salut" in text:
        ...
        try:
            ...
            await update.message.reply_text(f"sorry les vidéos sont lourdes. Nous vous reviendrons avec un meilleur résultat : {e}")
